  ...
  return (
    <section id="experience" className="w-full relative z-10 flex justify-center px-4 sm:px-8 py-20" aria-labelledby="experience-heading">
      <div className="w-full max-w-7xl">
        ...
        <SectionReveal selector=".experience-heading" staggerIn={0.15} staggerOut={0.20} inStart="top 75%" inEnd="bottom bottom" outStart="bottom 20%" outEnd="bottom 10%">
          <div className="flex items-center gap-4 experience-heading slide-up-and-fade">
        ...
        {items.length === 0 ? (
          ...
          /* Each experience wrapped with its own SectionReveal - Timeline style */
          <div className="relative mt-10">
            ...
            <div className="space-y-8">
              {items.map((exp, index) => (
                <SectionReveal key={exp.id} selector=".experience-item" staggerIn={0.15} staggerOut={0.20} inStart="top 75%" inEnd="bottom bottom" outStart="bottom 40%" outEnd="bottom 20%">
                  <div className="experience-item slide-up-and-fade relative">
                    ...
                    <div className="hidden md:block absolute left-0 top-8 w-[140px] text-right pr-6">
                      {areSameMonth(exp.startDate, exp.finishDate) ? (
                        <p className="text-white/90 text-xl font-bold whitespace-nowrap">
                        ...
                        <>
                          ...
                          <p className="text-white/90 text-xl font-bold whitespace-nowrap">
                            {exp.finishDate ? formatDate(exp.finishDate) : "Present"}
                          </p>
                        </>
                      )}
                    </div>
                    ...
                    <div className="md:ml-[186px] relative group">
                      <div className="relative p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-gradient-primary/50 transition-all duration-300">
                        ...
                        <div className="relative z-10">
                          ...
                          {/* Description */}
                          {exp.description && (
                            <div className="prose prose-invert max-w-none text-white/70 prose-ul:space-y-2 prose-li:text-white/70 prose-strong:text-white prose-strong:font-bold" 
